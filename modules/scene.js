...
let envMap;
const normalMap = texLoader.load('../assets/normal.jpg');
...
texLoader.load('../assets/env.jpg', (res) => {
  ...
  /*boxes.forEach((b) => {
    b.mesh.material.envMap = envMap;
    b.mesh.material.envMapIntensity = 1.;
...
function updateWrappingPaper(ptr) {
  const box = boxes[ptr];
  box.mesh.material.map.setSize(512, 512);
